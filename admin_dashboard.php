...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <!-- <section> begin -->
    <section class="vh-100 d-flex align-items-center justify-content-center" id="feature" style="background-color:rgb(246, 238, 226);">
          ...
          <div class="col-md-4">
              <div class="card">
                  <div class="card-body text-center">
                      ...
                      <p class="card-text">Add New Blogs</p>
                      <a href="add-blog.php" class="btn btn-info">Add Blog</a>
                  </div>
              </div>
          </div>
          <div class="col-md-4">
              <div class="card">
                  <div class="card-body text-center">
                      <h5 class="card-title">Modify Blog</h5>
                      <p class="card-text">Update or Modify Existing Blogs</p>
                      <a href="modify-blog.php" class="btn btn-info">Modify Blog</a>
                  </div>
              </div>
          </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="card">
                  <div class="card-body text-center">
                      ...
                      <p class="card-text">Add New Images</p>
                      <a href="add-image.php" class="btn btn-info">Add Image</a>
                  </div>
              </div>
          </div>
        </div>
